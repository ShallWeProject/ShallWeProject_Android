...
class FaqFragment : Fragment() {
    ...
    private fun setupRecyclerView(recyclerView: RecyclerView) {
        ...
        faqData.apply {
            ...
            add(
                FaqDto(
                    "왜 선물을 보내는 사람이 날짜와 시간을 지정해야 하나요?",
                    "셸위는 ‘함께하는 경험’을 소중히 생각합니다. 따라서 선물을 보내는 사람이 날짜와 시간을 지정하여 선물을 보내도록 되어 있습니다. 선물을 받는 사람이 예약된 날짜와 시간을 변경할 수도 있으니, 만약 함께하는 경험이 아니라면 아무 날짜나 임의 지정하여 선물을 보내주세요!"
                )
            )
            add(
                FaqDto(
